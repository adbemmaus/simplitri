...
<div class=" col-lg-2 spinnerLN">
  <?php
      ...
      echo form_open('Cartouches_Qualification_CEL',$attributes);
  ?>
   <div class="row">
    <button type="submit" class="btn {BTN_UP_CLASS} dim btn-xlarge" name="{BTN_UP_NAME}" >{CEL_NAME}</button>
   </div>
   <div class="row">
    <input type="text" disabled="" value="{CEL}" class="spinner1"/>
   </div>
   <div class="row">
        ...
        <div class="modal-content animated fadeIn">
          ...
          ?>
            <div class="modal-header">
                ...
                <h4 class="modal-title">Modification {CEL_NAME}</h4>
                <small>Pour retirer une valeur saisir une valeur négative</small>
            </div>
            <div class="modal-body">
               <center>
               <input type="number" name="{INPUT_CEL}" value="0" autofocus class="spinner1"/>
               </center>
